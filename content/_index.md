...
* Twelve pre-configured snippets, including diff syntax highlighting, Gist embeds, and tree diagram formatter;
...
CloudCannon uses Alto as the template for our open-source tools. Take a look at these sample sites to see what's possible with static documentation:&nbsp;
